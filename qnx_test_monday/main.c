    ...
    while (state.running) {
        ...
        if (key || up || down || left || right) {
            ...
            //TRUDYMISHA AND JAZ NEEDS TO FIX ARBITARY
                ...
                if (strcmp(state.arb_file, DEFAULT_WAVE) == 0)
                    strcpy(state.arb_file, WAVE1);
                else if (strcmp(state.arb_file, WAVE1) == 0)
                    strcpy(state.arb_file, WAVE2);
                else if (strcmp(state.arb_file, WAVE2) == 0)
                    strcpy(state.arb_file, WAVE3);
                else
                    strcpy(state.arb_file, DEFAULT_WAVE);
